...
/***/ function(module, exports, __webpack_require__) {
	...
	var CharachterBox = __webpack_require__(159);
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(CharachterBox, { questions: questions, charachters: charachters }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CharachterList = __webpack_require__(160);
	var CharachterGuess = __webpack_require__(162);
	
	var CharachterBox = React.createClass({
	  displayName: 'CharachterBox',
	  ...
	  makeGuess: function makeGuess(questionId) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(CharachterList, { charachters: this.props.charachters }),
	      React.createElement(CharachterGuess, { questions: this.props.questions, makeGuess: this.makeGuess }),
	      React.createElement(
	        'button',
	        { type: 'submit', onClick: this.startGame },
	        'Start Game'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Charachter = __webpack_require__(161);
	
	var CharachterList = React.createClass({
	  displayName: 'CharachterList',
	    ...
	    var charachterNode = this.props.charachters.map(function (charachter) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'box' },
	          React.createElement(Charachter, { key: charachter.id, charachter: charachter })
	        )
	      );
	    });
	    return React.createElement(
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h2',
	        null,
	        React.createElement('img', { src: this.props.charachter.img })
	      )
	    );
	  }
	...
	var CharachterGuess = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { type: "submit", onClick: this.makeGuess },
	        "Guess"
	      )
	    );
	  }
